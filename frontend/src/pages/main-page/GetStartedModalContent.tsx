...
const GetStartedModalContent = ({closeModal}: GetStartedModalContentProps) => {
    return (
        <div className="relative w-full max-w-md max-h-full">
            <div className="relative rounded-lg shadow-lg bg-slate-800">
                ...
                <div className="px-6 py-6 lg:px-8">
                    <p className="mb-4 text-3xl font-medium text-white">Sign in to our platform</p>
                    <form className="space-y-6" action="#">
                        <div>
                            <label htmlFor="email"
                                   className="block mb-2 text-lg font-medium text-white">Your email</label>
                        ...
                        <div>
                            <label htmlFor="password"
                                   className="block mb-2 text-lg font-medium text-white">Your password</label>
                        ...
                        <button type="submit"
                                className="w-full text-white focus:ring-4 focus:outline-none font-medium rounded-lg text-xl px-5 py-2.5 text-center bg-sky-600 hover:bg-sky-700">Login
                            to your account
                        </button>
                        <div className="text font-medium text-gray-300">
                            Not registered?
                            <Link to="/register" className="hover:underline text-sky-500"> Create account</Link>
                        </div>
                    </form>
                </div>
            </div>
