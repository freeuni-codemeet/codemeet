        ...
        <>
            ...
            <nav className="absolute w-full flex flex-row justify-between items-center px-8 py-5">
                <div className={"flex flex-row gap-2 items-center"}>
                    <BsCodeSlash className={"w-12 h-12 p-2 font-bold rounded-full bg-sky-950 shadow-2xl"}/>
                    <p className={"text-4xl font-bold"}>Codemeet</p>
                </div>
                <a href={"https://github.com/freeuni-codemeet/codemeet"}>
                    <svg className="w-8 h-8 opacity-60 hover:opacity-100" aria-hidden="true"
            ...
            <div className={"flex h-screen justify-center items-center bg-gradient-to-t from-slate-800 to-slate-900"}>
