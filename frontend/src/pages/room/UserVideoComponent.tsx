                ...
                <div className={"group"}>
                    ...
                    >
                        <video autoPlay={true} ref={videoRef}
                               className={`rounded-xl w-full aspect-[4/3] ${streamManager.stream.videoActive ? "visible" : "invisible"}`}
                        />
                        <div className={`absolute top-0 left-0 w-full h-full flex justify-center items-center ${!streamManager.stream.videoActive ? "visible" : "invisible"}`}>
